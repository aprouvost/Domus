...
public class GlobalKeyListenerExample implements NativeKeyListener {
    ...
    public void nativeKeyPressed(NativeKeyEvent e) {
        listener.userActions.add(new ActionR(AType.KEYPRESS,createAwtKeyEvent(e)));
    ...
    public void nativeKeyReleased(NativeKeyEvent e) {
        listener.userActions.add(new ActionR(AType.KEYRELEASE,e.getKeyCode()));
    }
    ...
    int createAwtKeyEvent(NativeKeyEvent e) {
